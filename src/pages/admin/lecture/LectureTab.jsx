    ...
    <Card>
        ...
        <CardContent>
            <div>
                ...
                <Input type="text" value={lectureTitle} onChange={(e)=>setLectureTitle(e.target.value)} placeholder="Introduction To Javascript" />
            </div>
            <div className='my-5'>
                <Label className="mb-1">Video<span className='text-red-500'>*</span></Label>
                <Input type="file" accept="video/*" onChange={fileChangeHandler} placeholder="Introduction To Javascript" className="w-fit"/>
            </div>
