...
export default function Profile() {
    ...
    const [updateUser,{data:updateUserData,isLoading:updateUserLoading,isError,isSuccess}]=useUpdateUserMutation();
    ...
    useEffect(()=>{
        ...
        if(isError){
            toast.error(isError.message || "Profile updatation failed")
        }
